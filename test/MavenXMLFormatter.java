...
public class MavenXMLFormatter implements JUnitResultFormatter, XMLConstants, IgnoredTestListener {
    ...
    public MavenXMLFormatter(MavenTestRunner mavenTestRunner) {
